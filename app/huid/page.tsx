...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'HUID Hallmarking Info - Sapna Shri Jewellers Nagda',
    description: 'BIS प्रमाणित HUID हॉलमार्किंग का महत्व जानें। असली और सुरक्षित निवेश के लिए जरूरी जानकारी।',
    url: `${baseURL}/huid/`,
    images: [
      {
        url: imageUrl,
  ...
  return (
    <article className="container mx-auto max-w-4xl px-4 py-6">
      ...
      <header className="border-theme/40 my-6 flex items-center gap-3 border-b pb-2">
        ...
        <h2 className="text-2xl font-bold sm:text-3xl md:text-4xl">HUID हॉलमार्किंग क्यों ज़रूरी है?</h2>
      </header>

      {/* Main Content Section */}
      <section
        aria-labelledby="overview-heading"
        className="text-muted-foreground space-y-4 text-base leading-relaxed md:text-lg"
      >
        ...
        <p>
          ...
          <strong className="text-foreground">विशेष 6-अंकों का अल्फ़ान्यूमेरिक कोड</strong> होता है, जो प्रत्येक सोने और
          चांदी के आभूषण पर लेज़र द्वारा अंकित किया जाता है। यह कोड प्रमाणित करता है कि आपका आभूषण{' '}
          <strong className="">BIS (भारतीय मानक ब्यूरो)</strong> के शुद्धता मानकों के अनुरूप प्रमाणित है।
        </p>

        <ul className="list-disc space-y-2 pt-2 pl-6">
          <li>
            हर आभूषण का विशिष्ट <strong>HUID नंबर</strong> होता है — जो ज्वेलरी की व्यक्तिगत पहचान सुनिश्चित करता है।
          </li>
          <li>
            यह डेटा सीधे BIS के केंद्रीय डेटाबेस में सुरक्षित रहता है, जिससे मिलावट या अमान्य हॉलमार्किंग की गुंजाइश
            खत्म हो जाती है।
          </li>
          <li>
      ...
      <section aria-labelledby="visual-guide-heading" className="mt-10">
        <h2 id="visual-guide-heading" className="text-accent mb-4 text-xl font-bold">
          हॉलमार्क कहाँ और कैसे देखें:
        </h2>
        <div className="flex flex-col items-center justify-center gap-6 sm:flex-row">
          <figure className="w-full max-w-md text-center">
            <div className="border-theme/60 bg-surface relative aspect-[16/10] w-full overflow-hidden rounded-xl border shadow-sm">
              <Image
        ...
        <div className="space-y-4">
          {faqs.map((item, index) => (
            <details
              key={item.q}
              open={index === 0}
              className="group border-theme bg-surface open:ring-primary/20 rounded-xl border p-4 shadow-sm transition-all open:ring-1"
            >
              <summary className="flex cursor-pointer list-none items-center justify-between text-base font-semibold select-none md:text-lg">
                <span>{item.q}</span>
                <span
                  className="text-muted-foreground text-xs transition-transform duration-200 group-open:rotate-180"
                  aria-hidden="true"
                >
                  ▼
                </span>
              </summary>
              <p className="text-muted-foreground mt-3 pl-1 text-sm leading-relaxed md:text-base">{item.a}</p>
            </details>
          ))}
        </div>
      </section>

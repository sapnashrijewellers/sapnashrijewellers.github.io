...
const policies = [
  ...
  },
  {
    ...
    description:
      'Legal terms and conditions for task360 services. Read our Terms of Service to understand your rights and responsibilities when scaling your business with us.',
  },
  {
    slug: 'shipping',
    title: 'Shipping Policy',
    description:
      'Learn about our shipping policies, including delivery times and costs, to ensure a smooth shopping experience.',
  },
  {
    slug: 'disclaimer',
    title: 'Disclaimer',
    description:
      'Legal terms and conditions for task360 services. Read our Disclaimer to understand your rights and responsibilities when scaling your business with us.',
  },
  {
    slug: 'returns',
    title: 'Return Policy',
    description:
      'Learn about our return policies, including eligibility and procedures, to ensure a hassle-free shopping experience.',
  },
  {
    slug: 'warranty',
    title: 'Warranty Policy',
    description:
      'Learn about our warranty policies, including eligibility and procedures, to ensure a hassle-free shopping experience.',
  },
];
...
export default async function PrivacyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main className="policy-container mx-auto max-w-5xl px-4 py-16">
      <header className="mb-12">
        <h2 className="mb-4 text-4xl font-bold">{frontmatter.title}</h2>

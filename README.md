# Jewellery catalog website
Product catalog website built using Next.js and React. Visit [sapnashrijewellers.in](httpd://sapnashrijewellers.in)

## Website features:
1. Elegantly present you jewelry product catalog in different views. 
1. SEO and LLM friendly structure. 
    1. User defined title, description and keywords for SEO. 
    1. Per product SEO
    1. JSON LD integration for each product
...
1. Customized view of your catalo pointing to different landing pages
    1. Home Page:              
        1. Live rates updates every 5 min
        1. Ticker to promote important announcements
        1. Customized banner
            1. Banner heading
            1. Text position
            1. Text animation
            ...
            1. Custom image
            1. Navigate banner
            1. No limit on number of banners
        1. Jewellery type bar to showcase jewellery for every occasion with hundreds of jewellery type customization. it lands to jewellery type landing page to show all related jewelries.
        1. New arrival section --> lands to product detail page

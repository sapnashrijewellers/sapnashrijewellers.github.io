        ...
        {activeTypes.map((item) => {
          ...
          return (
            <Link
              ...
              className="group bg-surface relative flex w-28 shrink-0 snap-start flex-col items-center gap-2 rounded-2xl p-2 text-center shadow-sm transition-[transform,box-shadow,border-color] duration-150 ease-out will-change-[transform] hover:-translate-y-1 hover:shadow-md"
            >
              {/* Badge / Icon Wrapper */}
              <div className="ring-primary/20 group-hover:ring-primary/40 relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-amber-500/10 to-orange-500/10 ring-1 transition-colors duration-150 group-hover:from-amber-500/20 group-hover:to-orange-500/20 sm:h-16 sm:w-16">
                ...
                <span
                  className="absolute inset-1 rounded-full border border-dashed transition-transform duration-300 ease-out group-hover:rotate-45"
                  aria-hidden="true"
                />
